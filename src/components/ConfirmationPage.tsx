...
const styles = {
  ...
  stepCircle: (active: boolean, completed: boolean) => ({
    ...
    alignItems: 'center',
    justifyContent: 'center',
    background: completed ? colors.status.success : active ? colors.primary.gradient : '#E2E8F0',
            ...
            <React.Fragment key={index}>
              ...
              >
                <div style={styles.stepCircle(isActive, isCompleted)}>
                  {isCompleted || isActive ? <CheckCircle size={18} /> : <StepIcon size={18} />}
                </div>
              </motion.div>
...
const Confetti: React.FC = () => {
  const confettiPieces = Array.from({ length: 50 }, (_, i) => ({
    ...
    color: ['#1E88E5', '#00C853', '#7C4DFF', '#FF6B35', '#FFB020'][Math.floor(Math.random() * 5)],
  }));
        ...
        <>
          ...
          >
            ...
            >
              ...
              <h2 style={{ fontSize: '24px', fontWeight: 700, color: colors.text.primary, margin: '0 0 12px' }}>
                Application Submitted!
              </h2>
              <p style={{ fontSize: '15px', color: colors.text.secondary, lineHeight: 1.6, margin: '0 0 24px' }}>
                Your loan application has been successfully submitted. You will receive an SMS and email notification within 24 hours.
              </p>
...
const ConfirmationPage: React.FC = () => {
  ...
  // Sample loan data (in real app, this would come from API/state)
  const [loanData, setLoanData] = useState({
    ...
    processingFee: 1000,
    totalInterest: 15000,
    totalRepayment: 116000,
    monthlyPayment: 38667,
      ...
      <div style={styles.innerContainer}>
        ...
        >
          ...
          <p style={styles.subtitle}>
            Your loan application has been submitted successfully. Here&apos;s a summary of your application.
          </p>
          ...
          >
            ...
            <div style={styles.summaryRow}>
              ...
              <span style={{ ...styles.summaryValue, color: colors.secondary.main }}>
          ...
          >
            <Shield size={20} color={colors.status.warning} style={{ flexShrink: 0, marginTop: '2px' }} />
            <div>
              <p style={{ fontSize: '14px', fontWeight: 500, color: colors.text.primary, margin: '0 0 4px' }}>
                What happens next?
              </p>
              <p style={{ fontSize: '13px', color: colors.text.secondary, margin: 0, lineHeight: 1.6 }}>
                Your application will be reviewed within 24 hours. Once approved, the loan will be disbursed to your verified bank account.
              </p>
            </div>
          </motion.div>
